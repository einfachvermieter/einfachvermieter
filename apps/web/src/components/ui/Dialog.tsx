...
/**
 * Scrollbarer Inhaltsbereich zwischen Header und Footer
 */
const DialogBody = ({ className, ...props }: ComponentProps<"div">) => (
  <div
    data-slot="dialog-body"
    className={cn("scroll-shadow-y min-h-0 overflow-y-auto", className)}
    {...props}
  />
);
