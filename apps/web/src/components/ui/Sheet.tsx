...
const SheetContent = ({
  ...
  /**
   * "form": breiteres Sheet für Formulare; wächst auf großen Bildschirmen
   */
  size?: "default" | "form";
  ...
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      className={cn(
        ...
        size === "form" &&
          "data-[side=left]:sm:max-w-sheet-form data-[side=right]:sm:max-w-sheet-form",
        className,
      )}
      {...props}
    >
...
const SheetTitle = ({
  ...
  <SheetPrimitive.Title
    ...
    className={cn(
      "flex min-h-8 items-center gap-2.5 text-lg font-semibold text-foreground",
      className,
    )}
    {...props}
  />
