...
export const buildSystemPrompt = (costTypes: CostTypeForPrompt[]): string => {
  ...
  return [
    ...
    "- warnings: Hinweise für die Person, die die Rechnung prüft. In deutscher",
    "  Alltagssprache und ohne technische Feldnamen: also „Kostenart“ statt",
    "  costTypeId, „Betrag“ statt amountGrossCents, „Zeitraum“ statt periodStart.",
    "  Nur aufnehmen, was für die Prüfung wirklich zählt: Positionen ohne",
    "  Kostenart, unsichere Beträge oder Zeiträume, ungewöhnliche Rechnungen.",
    "  Nichts über die interne Verarbeitung und keine Selbstverständlichkeiten.",
    "",
