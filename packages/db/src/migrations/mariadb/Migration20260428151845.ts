...
export class Migration20260428151845 extends Migration {
  ...
  override up(): void | Promise<void> {
    this.addSql(`create table \`app_settings\` (\`id\` varchar(255) not null default 'default', \`sender_name\` varchar(255) not null default '', \`sender_address_street\` varchar(255) not null default '', \`sender_address_postal_code\` varchar(255) not null default '', \`sender_address_city\` varchar(255) not null default '', \`sender_phone\` varchar(255) null, \`sender_fax\` varchar(255) null, \`sender_email\` varchar(255) null, \`sender_bank_name\` varchar(255) null, \`sender_bank_iban\` varchar(255) null, \`sender_bank_bic\` varchar(255) null, \`logo_mode\` varchar(255) not null default 'app', \`logo_alignment\` varchar(255) not null default 'center', \`logo_scale_percent\` int not null default 100, \`logo_storage_key\` text null, \`logo_mime_type\` varchar(255) null, \`ai_provider\` varchar(255) null, \`ai_api_key\` text null, \`ai_base_url\` text null, \`ai_model\` varchar(255) null, \`climate_factors_auto_fetch\` tinyint(1) null, \`update_check_enabled\` tinyint(1) null, \`telemetry_enabled\` tinyint(1) null, \`installation_id\` varchar(255) null, \`telemetry_last_sent_at\` varchar(255) null, \`last_app_version\` varchar(255) null, \`created_at\` varchar(255) not null default current_timestamp, \`updated_at\` varchar(255) not null default current_timestamp, primary key (\`id\`)) default character set utf8mb4 engine = InnoDB;`);
    ...
    this.addSql(`create table \`meters\` (\`id\` varchar(255) not null, \`building_id\` varchar(255) not null, \`unit_id\` varchar(255) null, \`type\` varchar(255) not null, \`role\` varchar(255) not null, \`label\` varchar(255) not null, \`serial_number\` varchar(255) null, \`measurement_unit\` varchar(255) not null, \`room\` varchar(255) null, \`cost_allocation_mode\` varchar(255) not null default 'cost_types', \`radiator\` varchar(255) null, \`k_total\` double null, \`radiator_manufacturer\` varchar(255) null, \`radiator_model\` varchar(255) null, \`radiator_type\` varchar(255) null, \`radiator_dimensions\` varchar(255) null, \`valid_from\` varchar(255) not null, \`valid_until\` varchar(255) null, \`reset_day\` varchar(255) null, \`is_active\` tinyint(1) not null default true, \`is_remote_readable\` tinyint(1) not null default false, \`created_at\` varchar(255) not null default current_timestamp, \`updated_at\` varchar(255) not null default current_timestamp, primary key (\`id\`)) default character set utf8mb4 engine = InnoDB;`);
    ...
    this.addSql(`create table \`climate_factors\` (\`id\` varchar(255) not null, \`postal_code\` varchar(255) not null, \`period_start\` varchar(255) not null, \`period_end\` varchar(255) not null, \`factor\` double not null, \`is_manual\` tinyint(1) not null default false, \`created_at\` varchar(255) not null default current_timestamp, \`updated_at\` varchar(255) not null default current_timestamp, primary key (\`id\`)) default character set utf8mb4 engine = InnoDB;`);
    this.addSql(`alter table \`climate_factors\` add unique \`climate_factors_postal_code_period\` (\`postal_code\`, \`period_start\`, \`period_end\`);`);
    ...
    this.addSql(`alter table \`operating_cost_statements\` add unique \`operating_cost_statements_reference_unique\`(\`sequence_year\`, \`sequence_number\`, \`revision_number\`);`);
