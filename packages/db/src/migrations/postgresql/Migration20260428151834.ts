...
export class Migration20260428151834 extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`create table "cost_entries" ("id" varchar(255) not null, "invoice_date" varchar(255) not null, "invoice_number" varchar(255) null, "vendor" varchar(255) null, "document_path" text null, "notes" text null, "created_at" varchar(255) not null default current_timestamp, "updated_at" varchar(255) not null default current_timestamp, primary key ("id"));`);
    ...
    this.addSql(`create table "meters" ("id" varchar(255) not null, "building_id" varchar(255) not null, "unit_id" varchar(255) null, "type" varchar(255) not null, "role" varchar(255) not null, "label" varchar(255) not null, "serial_number" varchar(255) null, "measurement_unit" varchar(255) not null, "room" varchar(255) null, "cost_allocation_mode" varchar(255) not null default 'cost_types', "radiator" varchar(255) null, "k_total" double precision null, "radiator_manufacturer" varchar(255) null, "radiator_model" varchar(255) null, "radiator_type" varchar(255) null, "radiator_dimensions" varchar(255) null, "valid_from" varchar(255) not null, "valid_until" varchar(255) null, "is_active" boolean not null default true, "created_at" varchar(255) not null default current_timestamp, "updated_at" varchar(255) not null default current_timestamp, primary key ("id"));`);
